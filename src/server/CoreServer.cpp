...
=======
>>>>>>> 388ac5660ebbe30b9cac16598899562e3aac76bb
...
class PointStoreHandler : virtual public PointStoreIf {
 public:
  PointStoreHandler() : PointStoreIf() {
    auto* dataSourceConfig = new DataStoreConfig();
    dataStore_ = new DataStore(dataSourceConfig);
  }
